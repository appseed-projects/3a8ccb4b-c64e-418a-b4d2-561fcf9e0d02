...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-05 19:28`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3a8ccb4b-c64e-418a-b4d2-561fcf9e0d02.git
$ cd 3a8ccb4b-c64e-418a-b4d2-561fcf9e0d02
```
